...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full bg-zinc-950/80 backdrop-blur-xl z-50 border-b border-zinc-900 transition-all">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a
              href="#reservas"
              className="px-6 py-2.5 bg-white text-zinc-950 text-xs uppercase tracking-widest font-semibold rounded-full hover:bg-zinc-200 transition-colors"
            >
              Reservar
            </a>
          </div>
      ...
      {/* Mobile Menu */}
      {isOpen && (
        <div className="md:hidden bg-zinc-950 border-b border-zinc-900 shadow-xl absolute w-full">
          <div className="px-4 pt-2 pb-6 space-y-2">
            ...
            <div className="pt-4">
              <a
                href="#reservas"
                onClick={() => setIsOpen(false)}
                className="block w-full text-center px-6 py-4 bg-white text-zinc-950 text-sm uppercase tracking-widest font-bold rounded-xl hover:bg-zinc-200 transition-colors"
              >
                Reservar Mesa
              </a>
            </div>
